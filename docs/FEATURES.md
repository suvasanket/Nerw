...
- **Date Math, Natural Relative Dates & Countdowns**: Calendar arithmetic (`August 5 + 5`, `3:45pm + 5`, `today + 90 days`), natural language relative dates (`monday in 3 weeks`, `next friday`, `first day of next month`), date countdowns (`days until 31 Mar`, `days left in quarter`), duration between dates (`time between 1 Jan and 15 Mar`), and ISO 8601 / Unix epoch conversions (`2024-03-15T14:30:00Z in local time`, `1700000000 in date`, `now in epoch`).
