...
## ⭐️ Unified Calculator, World Clock, Date Math & Conversions
- **Advanced Math & Functions**: Evaluate arithmetic expressions (`2 + 2`, `100 * (15 + 5)`), powers (`2 power 10`, `2^10`), roots (`square root of 625`), factorials (`5!`), constants (`pi`, `e`, `tau`), and word operators (`10 plus 20`, `half of 80`).
- **Complete Trigonometry Suite**: Full support for standard and reciprocal trigonometry (`sin`, `cos`, `tan`, `cot`, `sec`, `csc`), inverse functions (`asin`, `acos`, `atan`, `acot`, `asec`, `acsc`), and hyperbolic variants (`sinh`, `cosh`, `tanh`, `coth`, `sech`, `csch`, `asinh`, `acosh`, `atanh`) in degrees and radians (`cot(45 deg)`, `sec(60°)`).
- **Number Suffixes & Shorthands**: Supports `1K` (=1,000), `1M` (=1,000,000), `1B` (=1,000,000,000), and `1T` in expressions and currencies (`10K + 500`, `2.5M * 4`, `USD1K in EUR`, `10K in EUR`).
- **Financial Tips, Ratios & Percentages**: Instant tip calculator with bill splitting (`15% tip on 42`, `20% tip on 85 with 4 people`), ratio/aspect scaling (`ratio of 3 to 5`, `scale 16:9 to width 1920`), percentage discounts (`20% off 80`), and percentage change (`% increase from 50 to 75`).
...
- **13 Physical & Digital Unit Dimensions**: Full support for Length, Mass, Temperature, Volume, Area, Digital Data Storage, Speed, Duration, Energy, Power, Pressure, Angle, and Fuel Efficiency with compact expressions (`100km to miles`, `50kg in lbs`, `32f to c`), fractions (`1/2 cup to ml`), and compound units (`5 ft 10 in to cm`, `1 hr 30 min to sec`).
- **Human Timespan Formatting**: Formats durations into human breakdowns (`145 mins to timespan` -> `2h 25m`, `90000 seconds in timespan` -> `1d 1h`).
- **Work Week & Working Hours Planning**: Workday conversions and annual business hour calculations (`55h in workdays`, `workhours in 2026`).
- **Design & Typography Conversions**: Converts physical dimensions to pixels at custom DPI/PPI (`2 inches in px at 72 ppi`, `1920px in cm at 300 dpi`) and CSS web typography units (`16px in rem`, `1.5rem in px`, `24px in pt`).
- **World Clock & Timezones**: Real-time multi-city time lookup across 500+ global cities and top 100 airport IATA codes (`time in tokyo`, `time in JFK`, `time in São Paulo`), cross-city time conversions (`5pm ldn in sf`, `9am nyc in tokyo`), timezone differentials (`time diff Paris`, `diff Tokyo`), and time projections (`time in 4 hours in San Francisco`).
- **Date Math, Natural Relative Dates & Countdowns**: Calendar arithmetic (`August 5 + 5`, `3:45pm + 5`, `today + 90 days`), natural language relative dates (`monday in 3 weeks`, `next friday`, `first day of next month`, `3 weeks from now`), multi-format date countdowns (`days until next sunday`, `days until november`, `days to nov`, `days in november`, `days since 1 Jan 2026`, `how many days in february 2024`, `days until 31 Mar`, `days left in quarter/year/month`, `weeks until christmas`), holidays (`halloween`, `thanksgiving`, `christmas`, `new year`, `valentines`), duration between dates (`time between 1 Jan and 15 Mar`), and ISO 8601 / Unix epoch conversions (`2024-03-15T14:30:00Z in local time`, `1700000000 in date`, `now in epoch`).
- **Real-time & Cached Currency Exchange**: Convert between currencies using ISO codes (`19usd to jpy`, `100 USD to EUR`), currency symbols (`$100 to eur`, `€50 in usd`, `₹500 to usd`, `19$ in jpy`), or currency names (`100 dollars to euros`, `50 pounds in dollars`). Backed by Frankfurter (European Central Bank) exchange rates with 12h local caching and offline baseline fallbacks.
- **Intelligent Intent Recognition**: Automatically normalizes natural language queries directly to calculator, timezone, and conversion actions with zero input lag. Pressing `Enter` copies the clean result directly to the clipboard.
